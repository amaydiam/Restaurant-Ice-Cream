...
public class ManageMustahiqFragment extends DialogFragment implements CustomVolley.OnCallbackResponse, DialogPickCalonMustahiqFragment.PickCalonMustahiqListener {
    ...
    void Action(int id) {
        ...
        switch (id) {
            ...
            case Menus.SEND:
                ...
                jsonParams.put(RestaurantIceCream.status_mustahiq,
                        val_status_mustahiq);
                jsonParams.put(RestaurantIceCream.id_amil_zakat,
                        val_id_amil_zakat);
                ...
                if (action.equals("add")) {
                    ...
                    TAG = TAG_EDIT;
                    jsonParams.put(RestaurantIceCream.id_mustahiq,
                            val_id_mustahiq);
                }
    ...
    private void getData() {
        ...
        val_id_amil_zakat = amilZakatList.get(idAmilRestaurantIceCream.getSelectedItemPosition()).id_amil_zakat;
        ...
        try {
            ...
            if (Boolean.valueOf(res)) {
                if (!TAG.equals(TAG_DELETE)) {
                    JSONObject obj = new JSONObject(json.getString(RestaurantIceCream.mustahiq));
    ...
    public void setAmilZakat(ArrayList<AmilZakat> dataAmilZakat) {
        ...
        AmilRestaurant Ice CreamamilRestaurant Ice Cream= new AmilZakat("", "-Pilih Amil-");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        idAmilRestaurantIceCream.setAdapter(adapter);
        ...
        if (action.equals("edit")) {
            ...
            for (int i = 0; i < amilZakatList.size(); i++) {
                if (amilZakatList.get(i).id_amil_zakat.equals(val_id_amil_zakat)) {
                    idAmilRestaurantIceCream.setSelection(i);
                }
            }
